...
Point_2 getRnmdLoc(int xmin, int xmax, int ymin, int ymax) {
...
Circle_2 getRnmdLocOnMapCrcl(Circle_2 crcl, const double square) {
    Point_2 loc = getRnmdLoc(0, 30, 0, 10);
...
int main()
{
    ...
    while (cond_Var) {
        ...
        place_obj_crcl = getRnmdLocOnMapCrcl(place_obj_crcl, square);
